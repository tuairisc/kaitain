        ...
        a.extend(a.fn, {
            selectBox: function(i, u) {
                ...
                var n = function(B, x) {
                    ...
                    var w = a('<a class="selectBox" />'),
                        z = B.attr("multiple") || parseInt(B.attr("size")) > 1;
                    var v = x || {};
                    ...
                    if (z) {
                        ...
                        if (!B[0].style.height) {
                            ...
                            var y = w.clone().removeAttr("id").css({
                                position: "absolute",
                                top: "-9999em"
                            }).show().appendTo("body");
                        ...
                        var A = a('<span class="selectBox-label" />'),
                            C = a('<span class="selectBox-arrow" />');
                ...
                var m = function(w) {
                    w = a(w);
                    var z = w.data("selectBox-control"),
                        y = w.data("selectBox-settings"),
                        x = z.data("selectBox-options");
                    ...
                    x.css({
                        top: z.offset().top + z.outerHeight() - (parseInt(z.css("borderBottomWidth"))),
                        left: z.offset().left
                    });
                ...
                var f = function() {
                    ...
                    a(".selectBox-dropdown-menu").each(function() {
                        var w = a(this),
                            v = w.data("selectBox-select"),
                            y = v.data("selectBox-control"),
                            x = v.data("selectBox-settings");
                ...
                var p = function(w, v, B) {
                    w = a(w);
                    v = a(v);
                    var C = w.data("selectBox-control"),
                        A = w.data("selectBox-settings");
                ...
                var q = function(w, v) {
                    w = a(w);
                    v = a(v);
                    var y = w.data("selectBox-control"),
                        x = y.data("selectBox-options");
                ...
                var d = function(x, w, v) {
                    ...
                    x = a(x);
                    var C = x.data("selectBox-control"),
                        z = C.data("selectBox-options"),
                        A = C.hasClass("selectBox-dropdown") ? z : z.parent(),
                        B = parseInt(w.offset().top - A.position().top),
                        y = parseInt(B + w.outerHeight());
                    if (v) {
                ...
                var k = function(v, A) {
                    v = a(v);
                    var B = v.data("selectBox-control"),
                        w = B.data("selectBox-options"),
                        C = 0,
                        x = 0;
                ...
                var c = function(v, x) {
                    v = a(v);
                    var y = v.data("selectBox-control"),
                        w = y.data("selectBox-options");
                ...
                var e = function(v, y) {
                    ...
                    var x = v.data("selectBox-settings"),
                        w = z.data("selectBox-options");
                ...
                var o = function(C, D) {
                    C = a(C);
                    var y = C.data("selectBox-control"),
                        w = C.data("selectBox-settings");
                    switch (typeof(u)) {
                        case "string":
                            C.html(u);
                            break;
                    ...
                    var B = y.hasClass("selectBox-dropdown") ? "dropdown" : "inline",
                        D = j(C, B);
...
window.Mousetrap = function() {
    function m(a, e, b) {
        if (a.addEventListener) return a.addEventListener(e, b, !1);
    ...
    function q(a, e, b, c) {
        var f, g, d = [];
        if (!i[a]) return [];
        if ("keyup" == b && (15 < a && 19 > a || 91 == a)) e = [a];
        for (f = 0; f < i[a].length; ++f) g = i[a][f], !(g.seq && h[g.seq] != g.level) && (b == g.action && e.sort().join(",") === g.modifiers.sort().join(",")) && (c && i[a].splice(f, 1), d.push(g));
        return d
    }
    ...
    function r(a, e, b) {
        ...
        var f = c.tagName;
        c = -1 < (" " + c.className + " ").indexOf(" mousetrap ") ? !1 : "INPUT" == f || "SELECT" == f || "TEXTAREA" == f;
        if (!c) {
            c = [];
            b.shiftKey && c.push(j.shift);
            b.altKey && c.push(j.alt);
            b.ctrlKey && c.push(j.ctrl);
            b.metaKey && c.push(j.command);
            c = q(a, c, e);
            for (var g = {}, d = !1, f = 0; f < c.length; ++f)
                if (c[f].seq) d = !0, g[c[f].seq] = 1, c[f].callback(b);
                else if (!d && !k) {
                c[f].callback(b);
                break
            }
            e == k && !(15 < a && 19 > a || 91 == a) && n(g)
        }
    }

    function v(a) {
        r(93 == a.keyCode || 224 == a.keyCode ? 91 : a.keyCode, "keydown", a)
    }

    function w(a) {
        o === a.keyCode ? o = !1 :
            r(93 == a.keyCode || 224 == a.keyCode ? 91 : a.keyCode, "keyup", a)
    }
    ...
    function x(a, e, b, c) {
        ...
        var f = function() {
            ...
            g = function(a) {
                b(a);
                "keydown" === c && (o = a.keyCode);
                setTimeout(n, 10)
            },
            d;
        for (d = 0; d < e.length; ++d) t(e[d], d < e.length - 1 ? f : g, c, a, d)
    }

    function t(a, e, b, c, f) {
        var a = a.replace(/\s+/g, " "),
            g = a.split(" "),
            d, h = [];
        if (1 < g.length) return x(a, g, e, b);
        g = "+" === a ? ["+"] : a.split("+");
        for (a = 0; a < g.length; ++a) d = g[a], u[d] && (h.push(j.shift), d = u[d]), d = j[d] || d.toUpperCase().charCodeAt(0), (15 < d && 19 > d || 91 == d) && h.push(d);
        i[d] || (i[d] = []);
        q(d, h, b, !c);
        i[d][c ? "unshift" : "push"]({
            callback: e,
    ...
    for (var j = {
            ...
            "?": "/",
            "|": "\\"
        }, i = {}, p = {}, h = {}, s, o = !1, k = !1, l = 1; 20 > l; ++l) j["f" + l] = 111 + l;
    return {
        bind: function(a, e, b) {
            for (var b = b || "keydown", c = a instanceof Array ? a : a.split(","), f = b, g = 0; g < c.length; ++g) t(c[g], e, f);
            p[a + ":" + b] = e
        },
        trigger: function(a, e) {
            p[a + ":" + (e || "keydown")]()
        },
        addEvent: function(a, e, b) {
            m(a, e, b)
        },
        reset: function() {
            i = {};
