...
function kaitain_get_avatar_url($avatar, $id_or_email, $size, $default, $alt) {
   if (!is_admin()) {
...
add_filter('get_avatar', 'kaitain_get_avatar_url', 10, 5);
...
function kaitain_avatar_background_html($id_or_email, $size = 'large', $classes = null, $echo = true) {
